...
(function() {
  ...
  function PrepareController(prepareService) {
    ...
    vm.listItems = [{
      ...
      contents: {input1label: 'What do you want?',
                input1: null,
      ...
      contents: {input1label: 'What are your interests?',
                input1: null,
      ...
      contents: {input1label: 'What will happen to you if this doesn\'t happen ?',
                input1: null,
      ...
      contents: {input1label: 'What can you do to resolve the situation?',
                input1: null,
      ...
      contents: {input1label: 'What comments will the other person makethat you are likely to respond negatively to?',
                input1: null,
    ...
    this.toggleListItem = function(listItem) {
    ...
    this.isListItemShown = function(listItem) {

      return this.shownListItem === listItem;
    };
    this.isItemComplete = function(listItem) {
